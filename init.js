...
function queueLoaded(event) {
    ...
    deathSprite = new createjs.SpriteSheet({
...
function alienDeath() {
    deathAnimation = new createjs.Sprite(deathSprite, "die");
    deathAnimation.regX = 49;
...
function handleMouseDown(event) {
    ...
    createjs.Tween.get(crossHair).to({
        alpha: 0
    }, 1000);
